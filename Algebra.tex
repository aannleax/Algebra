...
\begin{example}
  ...
  Sei darüber hinaus $\text{Mod}(\mathcal{S}, \mathbb{N}) = (\mathcal{S}^\mathbb{N}_\text{Sum}, \mathcal{S}, \text{scal}_{S^\mathbb{N}})$
  mit $\mathcal{S}^\mathbb{N}_\text{Sum} = (S^\mathbb{N}, \sumcirc)$ gegeben.
  Beachte: $\text{scal}_\mathcal{S} \colon S \to \text{End}_{\mathcal{S}_\text{Sum}}$ mit 
  $\text{scal}(s): S \to S, s' \mapsto s \ast s'$.\\
  Das heißt: $\cdot_\mathcal{S} \colon S^2 \to S, (s,x) \mapsto s \ast x$.\\
  ...
  Sei außerdem $x \coloneqq \delta^\mathbb{N}_1$ und $x^n \coloneqq \underbrace{x \circledast ... \circledast x}_{n-fach}$
  also ist $x^n = \delta^\mathbb{N}_n$, wobei $\circledast$ die Faltung aus $\mathcal{S}[\mathbb{G}(\mathbb{N}_\text{add}, \bot)]$ ist.\\
  Dann ist 
  \begin{equation*}
...
\begin{example}
  ...
  Beachte: Hier werden $\text{Mod}(\mathcal{S}, \mathbb{N}^\Omega) = (\mathcal{S}^{\mathbb{N}^\Omega}_\text{Sum}, \mathcal{S}, \text{scal}_{S^{\mathbb{N}^\Omega}})$
  mit $\mathcal{S}^{\mathbb{N}^\Omega}_\text{Sum} = (S^{\mathbb{N}^\Omega}, \sumcirc)$ und die Faltung $\circledast$
