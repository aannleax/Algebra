...
\begin{definition}
  Eine Matrix über einer Menge $M$ (auch $M$-wertige Matrix) ist definiert als Tripel $(P, B, \alpha)$
...
\begin{proof}
  ...
  \begin{align*}
    ...
    &= \sum_{k \in K} v(k) \ast \delta^N_{\kappa(k)}(n) \\
...
\begin{example}
  ...
  und $\mathfrak{A} = (\mathcal{S}, \mathcal{S}, \text{scal}_\mathcal{S})$
  eine $\mathcal{S}$-Algebra ($\mathcal{S}$ als $\mathcal{S}$-Algebra).
  Darüber hinaus sei $\text{Mod}(\mathcal{S}, \mathbb{N}) = ((\mathcal{S}_\text{Sum})^\mathbb{N}, \mathcal{S}, \text{scal}_{S^\mathbb{N}})$
  mit $(\mathcal{S}_\text{Sum})^\mathbb{N} = (S^\mathbb{N}, \Sigmacirc)$ gegeben.
  Damit ist $\text{scal}_\mathcal{S} \colon S \to \text{End}_{\mathcal{S}_\text{Sum}}$ mit 
  $\text{scal}(s): S \to S, s' \mapsto s \ast s'$,
  wordurch die Operation $\cdot_\mathcal{S} \colon S^2 \to S, (s,x) \mapsto s \ast x$ definiert ist.
  ...
  wobei $\circledast$ die Faltung aus $\mathcal{S}[\mathbb{G}(\mathbb{N}_\text{add}, \bot)]$ ist.
...
\begin{example}
  ...
  und $\mathcal{S} = (S, \Sigma, \ast, \varepsilon)$ ein Summoid.
  Weiterhin sei $\mathbb{M} = (\mathbb{N}_\text{add})^\Omega$ ein kommutatives Monoid.
  Beachte: Hier werden $\text{Mod}(\mathcal{S}, \mathbb{N}^\Omega) = ((\mathcal{S}_\text{Sum})^{\mathbb{N}^\Omega}, \mathcal{S}, \text{scal}_{S^{\mathbb{N}^\Omega}})$
  mit $(\mathcal{S}_\text{Sum})^{\mathbb{N}^\Omega} = (S^{\mathbb{N}^\Omega}, \Sigmacirc)$ 
  und außerdem die Faltung $\circledast$
  aus $\mathcal{S}[\mathbb{G}((\mathbb{N}_\text{add})^\Omega, \bot)]$ betrachtet.
  
  Für $r \in S^\Omega$ ist 
  \begin{equation*}
    \kappa_r \colon \mathbb{N}^\Omega \to S, \alpha \mapsto \prod^\ast_{i \in \Omega}r_i^{\alpha_i}
  \end{equation*}
  ...
  Dann ist
  \begin{equation*}
    x^\alpha = \prod^\circledast_{i \in \Omega}x_i^{\alpha(i)}.
  \end{equation*}
  Interpretiere $u \in \mathcal{S}^{\mathbb{N}^\Omega}$ wie folgt:
  \begin{equation*}
    u = \sumcirc_{\alpha \in \mathbb{N}^\Omega} u(\alpha) \cdot_{S^{\mathbb{N}^\Omega}} \delta^{\mathbb{N}^\Omega}_\alpha = \sumcirc_{\alpha \in \mathbb{N}^\Omega} u(\alpha) \cdot_{S^{\mathbb{N}^\Omega}} x^\alpha = \sumcirc_{\alpha \in \mathbb{N}^\Omega} u(\alpha) \cdot_{S^{\mathbb{N}^\Omega}} \prod^\circledast_{i \in \Omega}x_i^{\alpha(i)}
  \end{equation*}
  Dann ist $f_{\kappa_r}$ ein Summoid-Homomorphismus von $\mathcal{S}[\mathbb{G}((\mathbb{N}_\text{add})^\Omega, \bot)]$ nach $\mathcal{S}$ und für $u \in \mathcal{S}^{\mathbb{N}^\Omega}$ ist
  \begin{equation*}
    f_{\kappa_r}(u) = \sum_{\alpha \in \mathbb{N}^\Omega}u(\alpha) \cdot_\mathcal{S} \kappa_r(\alpha) = \sum_{\alpha \in \mathbb{N}^\Omega}u(\alpha)\cdot_\mathcal{S} \prod^\ast_{i \in \Omega}r_i^{\alpha(i)}
  \end{equation*}
